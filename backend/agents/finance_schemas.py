"""Structured output schemas for the budget/savings/debt agents, ported
verbatim (as pydantic models) from AI Financial Coach Agent
(ai_financial_coach_agent.py), which used the same models as Google ADK
output_schema. Agno agents accept the same pydantic models via output_schema.
"""
